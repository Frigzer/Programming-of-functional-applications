...
public class CarShowroomContainer {
    ...
    private void initializeShowrooms() {
        ...
        showroom1.addProduct(new Vehicle("Toyota", "Corolla", ItemCondition.NEW, 80000, 2022, 10, 1700));
        showroom1.addProduct(new Vehicle("Ford", "Focus", ItemCondition.USED, 50000, 2019, 50000, 2300));
        showroom1.addProduct(new Vehicle("Audi", "SQ8", ItemCondition.USED, 399750, 2021, 24000, 2340));
        showroom1.addProduct(new Vehicle("Audi", "S6", ItemCondition.USED, 210000, 2018, 68500, 3210));
        showroom1.addProduct(new Vehicle("Audi", "RS7", ItemCondition.USED, 253000, 2016, 112013, 1930));
        showroom1.addProduct(new Vehicle("Ford", "Focus", ItemCondition.USED, 50000, 2019, 50000, 2300));
        showroom1.addProduct(new Vehicle("Ford", "Focus", ItemCondition.USED, 50000, 2019, 50000, 2300));
        showroom1.addProduct(new Vehicle("Toyota", "Corolla", ItemCondition.NEW, 80000, 2022, 10, 1700));

        // Dodanie pojazdów do salonu Kraków
        showroom2.addProduct(new Vehicle("Volkswagen", "Golf", ItemCondition.NEW, 90000, 2021, 5, 1500));
        showroom2.addProduct(new Vehicle("Honda", "Civic", ItemCondition.USED, 75000, 2018, 30000, 3400));
        showroom2.addProduct(new Vehicle("Honda", "Civic", ItemCondition.USED, 75000, 2018, 30000, 2700));
        showroom2.addProduct(new Vehicle("Mercedes-Benz", "EQS", ItemCondition.NEW, 418100, 2023, 1, 1520));
        showroom2.addProduct(new Vehicle("BMW", "M8", ItemCondition.USED, 630000, 2023, 9300, 4920));
        showroom2.addProduct(new Vehicle("Porche", "718 Cayman", ItemCondition.USED, 849000, 2023, 15693, 2525));
        showroom2.addProduct(new Vehicle("BMW", "M8", ItemCondition.USED, 439000, 2020, 79000, 4395));
